            ...
            {success ? (
              <div className="space-y-6">
                ...
                <Button
                  ...
                  className="btn-lumina w-full rounded-xl bg-linear-to-r from-electric-blue via-neon-pink to-cyber-purple py-4 text-base font-bold text-white shadow-lg h-auto cursor-pointer hover:opacity-90"
                >
                  Sign In
                </Button>
              </div>
