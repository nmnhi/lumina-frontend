          ...
          <div className="mx-auto w-full max-w-[420px] space-y-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl bg-white/3 border border-white/10 py-3.5 pl-4 pr-11 text-base text-zinc-100 placeholder-zinc-600 outline-none transition focus:border-white/20 focus:bg-white/6"
                  />
                  <button
                    type="button"
              ...
              <button
                ...
                className="btn-lumina w-full rounded-xl bg-linear-to-r from-electric-blue via-neon-pink to-cyber-purple py-4 text-base font-bold text-white shadow-lg disabled:opacity-50 mt-4 cursor-pointer"
              >
            ...
            <p className="text-center text-sm text-zinc-400 pt-1">
              ...
              <a
                href="#"
                className="font-semibold text-zinc-100 hover:text-electric-blue transition underline underline-offset-4"
              >
                Sign Up
              </a>
            </p>
